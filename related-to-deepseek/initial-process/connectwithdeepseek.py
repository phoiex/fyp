...
def interact_with_deepseek(user_input):
    try:
        # Vector retrieval context
        docs = vectordb.similarity_search(user_input, k=10)
        context = "\n\n".join(doc.page_content for doc in docs)

        # Generate Project Development Process Using DeepSeek Reasoner + RAG
        rag_messages = [
            {
                "role": "system",
                "content": (
        ...
        print("Reply has been saved as 'assistant_reply1.txt'")
